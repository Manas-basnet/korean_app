...
class _ChapterListPageState extends State<ChapterListPage> {
            ...
            sliver: SliverList(
              delegate: SliverChildBuilderDelegate(
                (context, index) {
                  ...
                  return _buildChapterCard(book, chapter, index, theme, colorScheme);
                },
  ...
  Widget _buildChapterCard(BookItem book, BookChapter chapter, int index, ThemeData theme, ColorScheme colorScheme) {
    return Container(
